let nit = "890300279"; // Carry out the necessary validations on the captured number. CAPM.
...
var arrayString = reverseString(nit);
...
var calculationBasis = accumulator % DIVIDER;
